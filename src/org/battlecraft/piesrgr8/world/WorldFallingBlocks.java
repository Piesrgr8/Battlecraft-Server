	...
	public void onEntityExplode(EntityExplodeEvent e) {
		...
		if (!e.blockList().isEmpty()) {
			...
			for (Block b : e.blockList()) {
				...
				if (b.getType() == Material.SAND || b.getType() == Material.GRAVEL || b.getType() == Material.REDSTONE
								|| b.getType() == Material.REDSTONE_COMPARATOR || b.getType() == Material.REDSTONE_COMPARATOR_OFF ||
								b.getType() == Material.REDSTONE_COMPARATOR_ON || b.getType() == Material.REDSTONE_LAMP_OFF || b.getType() == Material.REDSTONE_LAMP_ON
								|| b.getType() == Material.REDSTONE_TORCH_OFF || b.getType() == Material.REDSTONE_TORCH_ON || b.getType() == Material.REDSTONE_WIRE
